...
ASSIGN 
    XXTABVALXX = FRAME frm-C:MOVE-BEFORE-TAB-ITEM (FRAME frm-L:HANDLE)
    /* END-ASSIGN-TABS */.
...
FUNCTION Fc-Apagar RETURNS LOGICAL
    ...
    DO:
        ...
        MESSAGE "Exclusão de dados efetuada com sucesso." 
    ...
    do:
        assign 
            mensagem = oJsonRespObj:GetCharacter("message").
        MESSAGE "Falha na Exclusão (Não Autorizado): " mensagem 
    ...
    do:
        assign 
            mensagem = oJsonRespObj:GetCharacter("message").
        MESSAGE "Falha na Exclusão (Proibido): " mensagem 
            VIEW-AS ALERT-BOX ERROR.
    ...
    do:
        assign 
            mensagem = oJsonRespObj:GetCharacter("message").
        MESSAGE "Falha na Exclusão (Não Encontrado): " mensagem 
            VIEW-AS ALERT-BOX ERROR.
       
    end.
    ELSE 
    DO:
        MESSAGE "Erro desconhecido na Exclusão. Status:" oResp:StatusCode 
            VIEW-AS ALERT-BOX ERROR.
...
FUNCTION Fc-Atualizar RETURNS LOGICAL
    ...
    do:
        ...
        do:
            assign
                mensagem = oJsonRespObj:GetCharacter("message").
            MESSAGE oResp:StatusCode "Atualização de dados efetuada com sucesso." mensagem
                VIEW-AS ALERT-BOX INFO.
        ...
        do:
            assign 
                mensagem = oJsonRespObj:GetCharacter("message").
            MESSAGE oResp:StatusCode "Falha na Atualização (Não Autorizado): " mensagem 
                VIEW-AS ALERT-BOX ERROR.
        ...
        do:
            assign 
                mensagem = oJsonRespObj:GetCharacter("message").
            MESSAGE oResp:StatusCode "Falha na Atualização (Proibido): " mensagem 
                VIEW-AS ALERT-BOX ERROR.
        ...
        do:
            assign 
                mensagem = oJsonRespObj:GetCharacter("message").
            MESSAGE oResp:StatusCode "Falha na Atualização (Não Encontrado): " mensagem 
                VIEW-AS ALERT-BOX ERROR.
        end.
        ...
        do:
            ...
            MESSAGE oResp:StatusCode "Falha no Cadastro (Dados Inválidos): " mensagem SKIP codigo SKIP detalhes 
                VIEW-AS ALERT-BOX ERROR.
        end.                     
    end.
    CATCH e AS Progress.Lang.Error:
        MESSAGE "Erro: " e:GetMessage(1) 
            VIEW-AS ALERT-BOX.
    END CATCH.
    ...
    do:
        ...
        do:
            ...
            assign 
                ...
                .
            MESSAGE "Leitura de dados efetuada com sucesso." 
                VIEW-AS ALERT-BOX INFO.
        end.
        IF oResp:StatusCode eq 401 THEN 
        do:          
...
FUNCTION Fc-Logout RETURNS LOGICAL
    ...
    ELSE 
    DO:
        MESSAGE "Falha no logout. Código: " oResp:StatusCode 
            VIEW-AS ALERT-BOX ERROR.
...
FUNCTION Fc-Token RETURNS LOGICAL
    ...
    ASSIGN 
        id = oJsonPayload:GetCharacter("sub"). /* ARMAZENA O ID */
